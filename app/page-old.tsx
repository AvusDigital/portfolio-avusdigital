    ...
    <main className="bg-[#0D0D0E] text-[#F5F5F5] min-h-screen overflow-hidden">
      ...
      <section id="cases" className="min-h-screen px-8 md:px-14 py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* CARD 5 */}
          <a href="#" target="_blank" className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.02]">

            <div className="relative aspect-[16/10] overflow-hidden">
              <Image src="/images/case-beauty.png" alt="Beauty" fill className="object-cover transition-all duration-700 group-hover:scale-105" />
            </div>

            <div className="p-6">
              <p className="text-[11px] tracking-[0.3em] uppercase opacity-40">Avus</p>
              <h3 className="mt-3 text-2xl uppercase">Beauty</h3>
            </div>
          </a>
